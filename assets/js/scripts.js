(function ($, root, undefined) {
    ...
    function sticky_relocate() {
        var window_top = $('#scroll-div').scrollTop();
        var div_top = $('#sticky-anchor').position().top;
    ...
    $(function() {
        $('#scroll-div').scroll(sticky_relocate);
        sticky_relocate();
    });
    ...
    var SidebarMenuEffects = (function() {
      ...
      function init() {
        ...
        var container = document.getElementById( 'mobile-container' ),
          buttons = Array.prototype.slice.call( document.querySelectorAll( '#menu-open' ) ),
        ...
        buttons.forEach( function( el, i ) {
          ...
          el.addEventListener( eventtype, function( ev ) {
            ev.stopPropagation();
            ev.preventDefault();
            container.className = 'mobile-container'; // clear
    ...
    $('#menu-close').click(function() {
      classie.remove( document.getElementById( 'mobile-container' ), 'mobile-menu-open' );
    });
